...
function ViewProfile({ postContainerHeight = "80vh" }) {
  return (
    <section className="view-profile-container">
      ...
      <section className="view-profile-posts" style={{ height: postContainerHeight, maxHeight: postContainerHeight }}>
        ...
        <div
          style={{
            backgroundImage: "url(https://images.unsplash.com/photo-1506424482693-1f123321fa53?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bW90b3JiaWtlfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60)",
          }}
        ></div>
        <div style={{ backgroundImage: "url(https://cdn.pixabay.com/photo/2018/08/29/03/57/man-3639100_640.jpg)" }}></div>
        <div style={{ backgroundImage: "url(https://cdn.pixabay.com/photo/2021/05/27/18/15/motorcycle-6288958_640.jpg)" }}></div>
